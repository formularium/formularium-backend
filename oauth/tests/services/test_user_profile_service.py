...
class UserProfileServiceTest(TestCase):
    ...
    def setUp(self):
        ...
        self.test_user = get_user_model().objects.create_user(username="tester", password="refefe")

    def test_update_profile_basic_information(self):
        user = UserProfileService.update_user_basic_information(self.test_user, first_name="Bernd",
                                                                last_name="Lauert",
                                                                language="de-DE")
